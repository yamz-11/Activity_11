...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                diaglog.setItems(dialogItem, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        switch (i){
                             ...
                             */
                            case 0:
                                Intent intent = new Intent(getApplicationContext(), com.example.activity_11.EditorActivity.class);
        ...
        btnAdd.setOnClickListener(v ->{
            startActivity(new Intent(getApplicationContext(), com.example.activity_11.EditorActivity.class));
        });
    }
    @Override
